...
vertexai.init(project=settings.PROJECT_ID, location=settings.LOCATION_RAG)


class RagCorpusManager:
    def __init__(self, rag_dataset_folder=settings.RAG_DATASET_FOLDER):
        self.rag_dataset_folder = rag_dataset_folder
        self.rag_corpus_name_file = settings.RAG_CORPUS_NAME_FILE
