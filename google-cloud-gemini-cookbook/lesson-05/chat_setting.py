...
class ChatSettings:
    ...
    system_instruction: List[str] = field(
        default_factory=lambda: settings.SYSTEM_INSTRUCTION
    )
    cache_objects_list: List[str] = field(
        default_factory=lambda: settings.CACHE_OBJECTS_LIST
    )
